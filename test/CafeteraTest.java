...
class CafeteraTest {
  ...
  @Test
  public void prepareAndObtainCoffee(){
  ...
  @Test
  public void shouldNotGetACoffee(){
    Cafetera coffeemaker = new Cafetera();
    assertFalse( coffeemaker.giveMeACoffee(250) );
  }

  @Test
  public void shouldGetThreeCoffee(){
    Cafetera coffeemaker = new Cafetera();
  ...
  @Test
  public void noCoffeeCupWithoutWater(){
    Cafetera coffeemaker = new Cafetera();
  ...
  @Test
  public void noCoffeeCupWithoutCoffee(){
    Cafetera coffeemaker = new Cafetera();
